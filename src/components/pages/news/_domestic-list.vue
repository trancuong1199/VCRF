<template>
  <div>
    <div class="flex justify-between items-center">
      <div class="relative">
        <select id="filter" v-model="arrangeValue" @change="handleArrange(arrangeValue)">
      ...
      <div class="relative">
        <input class="search-item text-[8px] tablet:text-base" id="search" type="text" placeholder="Tìm kiếm thông tin..."
          v-model="searchValue" @keydown.enter="() => handleSearch(searchValue)" />
